...
source("R Code/AgIncentivesProcessing.R")

dir.create(paste0("./NRP/Final/",Sys.Date(), sep = ""))
...
source("R Code/ReportingConsortium.R")
...
readr::write_excel_csv(PUBLICVIEW, paste0("./NRP/Final/", Sys.Date(),"/PUBLICVIEW.csv", sep = ""))
readr::write_excel_csv(TABVIEW, paste0("./NRP/Final/", Sys.Date(),"/TABVIEW.csv", sep = ""))
...
readr::write_excel_csv(VERIFICATIONTOOL, paste0("./NRP/Final/", Sys.Date(),"/VERIFICATIONTOOL.csv", sep = ""))
...
write.csv(WORLDMAP, paste0("./NRP/Final/", Sys.Date(),"/WORLDMAP.csv",
                       sep=""), row.names = FALSE)
